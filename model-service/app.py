...
def photographer_analyze(request: PhotographerRequest, x_api_key: str | None = Header(default=None)):
    ...
    return PhotographerResponse(
        ...
        stopped_by_bbox_field=result.generation.stopped_by_bbox_field,
        stopped_by_json=result.generation.stopped_by_json,
        stopped_by_coordinate_pairs=result.generation.stopped_by_coordinate_pairs,
        partial_structure_used=result.parsed.partial_structure_used,
        json_complete=result.parsed.json_complete,
        bbox_field_complete=result.parsed.bbox_field_complete,
