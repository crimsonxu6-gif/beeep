...
export function PhotoPreviewScreen({ photo, onRetake, onSave, onBack, onGallery, statusMessage }: {
  photo: CapturedPhoto;
  onRetake: () => void;
...
const styles = StyleSheet.create({
  ...
  status: { position: "absolute", alignSelf: "center", bottom: 132, color: colors.white, backgroundColor: "rgba(0,0,0,0.7)", paddingHorizontal: 14, paddingVertical: 8, borderRadius: radii.md }
});
